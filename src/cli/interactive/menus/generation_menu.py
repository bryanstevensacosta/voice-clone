...
class GenerationMenu(BaseMenu):
    ...
    def run(self) -> str | None:
        ...
        # TODO: Update interactive menu for Qwen3-TTS
        console.print(
            "\n[yellow]⚠ Interactive generation menu not yet updated for Qwen3-TTS[/yellow]"
        )
        console.print("[dim]Please use CLI commands instead:[/dim]")
        console.print("[cyan]  voice-clone generate --help[/cyan]")
        console.print("[cyan]  voice-clone batch --help[/cyan]")
        console.print("[cyan]  voice-clone test --help[/cyan]\n")
        self.pause()
        return None

        # Original menu code commented out until Qwen3-TTS update
        # while True:
    ...
    #                 return
    #
    #             # TODO: Update to use Qwen3Generator
